...
class ConfirmNumberToUpdatePage extends StatefulWidget {
  final ProfileBloc bloc;

  const ConfirmNumberToUpdatePage({Key? key, required this.bloc})
      : super(key: key);

  @override
  State<ConfirmNumberToUpdatePage> createState() =>
      _ConfirmNumberToUpdatePageState();
}

class _ConfirmNumberToUpdatePageState extends State<ConfirmNumberToUpdatePage> {
  @override
...
class _LoadingWidget extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final isLoading = context.select((ProfileBloc bloc) => bloc.data.isLoading);
    return isLoading
        ? Container(
    ...
    return GestureDetector(
      ...
      child: Padding(
        ...
        child: Align(
          ...
          child: Text(
            '${LocaleKeys.lang_text.tr()} ${bloc.data.languageController.text}',
